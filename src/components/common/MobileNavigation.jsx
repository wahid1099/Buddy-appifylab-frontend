          ...
          <div className="row">
            <div className="col-xl-12 col-lg-12 col-md-12">
              <ul className="_mobile_navigation_bottom_list">
                ...
                <li className="_mobile_navigation_bottom_item">
                  <Link to="/friend-request" className="_mobile_navigation_bottom_link">
                ...
                <li className="_mobile_navigation_bottom_item">
                  <Link to="/notifications" className="_mobile_navigation_bottom_link">
                ...
                <li className="_mobile_navigation_bottom_item">
                  <Link to="/chat" className="_mobile_navigation_bottom_link">
